...
The CLI reference pages in [`docs/cli/`](docs/cli/) are generated from the commands themselves. After changing any CLI command, regenerate them:
...
Locale files live in [`frontend/src/i18n/`](frontend/src/i18n/) and can be edited directly. To add a new language, copy an existing locale file and translate the strings.
